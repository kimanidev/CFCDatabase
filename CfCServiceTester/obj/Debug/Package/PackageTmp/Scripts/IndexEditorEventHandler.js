...
function GenerateIndexModifyRequest(indexDbo) {
    ...
    var rzlt = { // rzlt is instance of UpdateIndexRequest object
        Operation: $(manager.get_hdIndexOperation5Id()).val(),
        CFC_DB_Major_Version: $(manager.get_txtMajorDbVersion4Id()).val(),
        CFC_DB_Minor_Version: $(manager.get_txtMinorDbVersion4Id()).val(),
        Table: $(manager.get_hdnSelectedTable4Id()).val(),
        OldIndexName: indexDbo.Name,
        IndexName: indexDbo.Name,
        DisableDependencies: $('#chkDisableDependencies4').attr('checked') == 'checked',
        IndexDescriptor: indexDbo
    };  
    return rzlt
}
