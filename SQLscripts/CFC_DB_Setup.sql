DECLARE @usrName [nvarchar](128) = N'Harry'
...
PRINT 'Granting server roles to login ' + @usrName + '...'
EXEC sp_addsrvrolemember @usrName, 'dbcreator'
EXEC sp_addsrvrolemember @usrName, 'processadmin'
EXEC sp_addsrvrolemember @usrName, 'serveradmin'
EXEC sp_addsrvrolemember @usrName, 'sysadmin'

PRINT 'Granting database roles to login ' + @usrName + '...'
EXEC sp_addrolemember 'db_accessadmin', @usrName
EXEC sp_addrolemember 'db_backupoperator', @usrName
EXEC sp_addrolemember 'db_datareader', @usrName
EXEC sp_addrolemember 'db_datawriter', @usrName
EXEC sp_addrolemember 'db_owner', @usrName
EXEC sp_addrolemember 'db_securityadmin', @usrName
GO
...
PRINT 'Recreate CFC_DB_Changes table...'
DECLARE @TABLE_NAME NVARCHAR(128) = 'CFC_DB_Changes';
